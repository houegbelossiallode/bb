...
@section('section')
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Importer les renseignements</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="{{ route('home') }}" class="breadcrumb">Home</a>
                <a href="#!" class="breadcrumb">Importer les renseignements</a>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="card">
            <div class="card-content">
                <h5 class="card-title">Importer les renseignements</h5>
                <form action="{{ route('renseignement.add', $id) }}" method="post" enctype="multipart/form-data">
                    @method('post')
                    @csrf
